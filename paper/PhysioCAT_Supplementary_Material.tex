...
\author{Youren Shang$^{1,2}$, Ningyuan Zhang$^{1,*}$\\
\small $^{1}$eHealth Research Institute, School of Management, Harbin Institute of Technology,\\
\small Harbin 150001, China\\
\small $^{2}$Faculty of Computing, Harbin Institute of Technology, Harbin 150001, China\\
